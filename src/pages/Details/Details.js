    ...
    await signer
      ...
      .then(async () => {
        ...
        if (
          ...
          await fetch(
            `${process.env.REACT_APP_SERVER_URL}/diamond/?token=${detailData.name}`,
            {
              method: 'GET',
            }
          )
          ...
          await fetch(
            `${process.env.REACT_APP_SERVER_URL}/ruby/?token=${detailData.name}`,
            {
              method: 'GET',
            }
          )
            ...
            <div className="headerLeftDiv">
              ...
              <div className="secondHeaderDiv">
                <div
                  ...
                  onClick={() =>
                    window.open(
                      contractLink(detailData.contractAddr, detailData.network),
                      '_blank'
                    )
                  }
                >
                  ...
                  <span>
                    &nbsp;&nbsp;Contract :{' '}
                    {contractReturn(detailData.contractAddr)}
                  </span>
                </div>
              </div>
              <div className="thirdHeaderDiv">
                ...
                <button
                  ...
                  onClick={handleOpenWatchListDlg}
                >
                  {returnWlBtnTitle()}
                </button>
              </div>
